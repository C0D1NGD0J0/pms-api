...
const ModelResources = {
  ...
  reportScheduleModel: asValue(ReportSchedule),
...
const ServiceResources = {
  ...
  reportAnalysisAIService: asClass(ReportAnalysisAIService).singleton(),
...
const DAOResources = {
  ...
  reportDAO: asClass(ReportDAO).singleton(),
  reportScheduleDAO: asClass(ReportScheduleDAO).singleton(),
